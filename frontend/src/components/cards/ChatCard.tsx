...
import { Card, CardContent, TextField, Button, Typography, Container, Grid, Box } from '@mui/material';
    ...
    return (
        <Card sx={{ height: 300, display: 'flex', flexDirection: 'column' }}>
            <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Box id="message-container" sx={{ maxHeight: '150px', overflowY: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'center', flexGrow: 1}}>
                    {response && (
